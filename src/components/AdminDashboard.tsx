...
import ContentLab from './ContentLab'; // <--- THIS FILE NOW CONTAINS YOUR AI & DATA ENGINE

const AdminDashboard: React.FC = () => {
  // --- STATE ---
  // We only track which tab is open. The logic for the Lab is inside ContentLab.
  const [activeAuditTab, setActiveAuditTab] = useState<'inventory' | 'datasets' | 'paths' | 'lab'>('lab');

  // --- EXPORT UTILITY (Kept from your old code) ---
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-8">
      ...
      {activeAuditTab === 'lab' ? (
        // HERE IS THE ENGINE!
        // We render the component that has the Data Factory and AI Logic.
        <ContentLab />
      ) : (
